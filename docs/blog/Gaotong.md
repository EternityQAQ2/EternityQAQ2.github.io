...
![](/assets/Gaotong/2_1.png)
![](/assets/Gaotong/图片1.jpg)
...
下左图，残差随拟合值增加而增加。
![](/assets/Gaotong/Y6.png)

####  离群点
离群点(outlier) 是指 Yi 远离模型预测值的点。
![](/assets/Gaotong/Y7.png)
...
![](/assets/Gaotong/图片5.png)

#### ROC曲线
![](/assets/Gaotong/图片6.png)
![](/assets/Gaotong/图片7.png)

### 二次判别分析
如果假设服从多元高斯分布，但每一类观测都有自己的协方差矩阵，则称作二次判别分析(quadratic discriminant analysis, QDA)
![](/assets/Gaotong/图片8.png)
...
![](/assets/Gaotong/图片16.png)
![](/assets/Gaotong/图片15.png)
...
>  从谱系图的底部开始，𝑛个观测各自都被看作一类
 ...
 ![](/assets/Gaotong/图片20.png)


![](/assets/Gaotong/图片21.png)
